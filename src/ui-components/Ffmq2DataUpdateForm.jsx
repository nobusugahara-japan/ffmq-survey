...
export default function Ffmq2DataUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = ffmq2DataRecord
      ? { ...initialValues, ...ffmq2DataRecord }
      : initialValues;
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Ffmq2Data0, idProp)
        : ffmq2Data;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Ffmq2Data0.copyOf(ffmq2DataRecord, (updated) => {
